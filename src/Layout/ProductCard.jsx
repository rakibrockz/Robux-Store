...
const ProductCard = ({ className,Price, src, detail}) => {
  return (
    <div className={` group md:w-[250px] sm:w-[220px] mx-2 w-[150px] md:mx-0 ${className} bg-white rounded-2xl overflow-hidden hover:scale-105 transition-all duration-200`}>
      <div className="">
