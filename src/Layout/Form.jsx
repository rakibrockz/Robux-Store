              ...
              >
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <input
                    ...
                    id="FirstName"
                    name="first_name"
                    className="w-full rounded-md border-gray-200 outline-none bg-white text-sm text-gray-700 shadow-sm py-4 border pl-3 mt-3  "
                ...
                <div className="col-span-6">
                  ...
                  <input
                    ...
                    id="Email"
                    name="email"
                    className=" w-full rounded-md border-gray-200 bg-white text-sm outline-none text-gray-700 shadow-sm py-4 border pl-3 mt-3 "
                ...
                <div className="col-span-6">
                  <label htmlFor="MarketingAccept" className="flex gap-4">
                    <input
                      ...
                      className="size-5 rounded-md border-gray-200 bg-white outline-none shadow-sm"
                    />
